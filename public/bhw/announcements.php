...
<body class="bg-gradient-to-br from-gray-50 to-blue-50 bhw-theme">
        ...
        <div class="content-header">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Stay updated with upcoming health center activities and programs</p>
                </div>
    ...
    <script>
        ...
        function initProfileDropdown() {
            ...
            if (!window.bhwAnnouncementsProfileDropdownClickHandler) {
                window.bhwAnnouncementsProfileDropdownClickHandler = function(e) {
                    const toggle = document.getElementById('profile-toggle');
                    const menu = document.getElementById('profile-menu');
                ...
                document.addEventListener('click', window.bhwAnnouncementsProfileDropdownClickHandler);
            }
