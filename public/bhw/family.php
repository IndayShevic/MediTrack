                             ...
                             data-relationship="<?php echo strtolower(htmlspecialchars($f['relationship'])); ?>"
                                ...
                                <div class="flex items-center space-x-3">
                                                <?php if (!empty($f['profile_image'])): ?>
                                                    <img src="<?php echo htmlspecialchars(upload_url($f['profile_image'])); ?>" 
                                                    ...
                                                    <div class="w-10 h-10 bg-gradient-to-br from-purple-500 to-indigo-600 rounded-lg flex items-center justify-center flex-shrink-0 text-white font-semibold text-sm hidden">
                                                        <?php 
                                                        $nameParts = explode(' ', $f['full_name']);
