        ...
        <div class="content-body">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="card-body text-center p-8">
                            <div class="relative inline-block mb-6">
                                <div class="relative group">
                                    ...
                                    <?php else: ?>
                                        <div class="profile-avatar rounded-full mx-auto bg-gradient-to-br from-primary-100 to-primary-200 flex items-center justify-center">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="card card-hover fade-in">
                        <div class="card-body p-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <button onclick="openUpdateProfileModal()" class="group p-6 bg-gradient-to-br from-primary-50 to-primary-100 rounded-xl border-2 border-primary-200 hover:border-primary-300 transition-all duration-300 hover:shadow-lg">
                                    <div class="flex items-center space-x-4">
                                        <div class="p-3 bg-primary-500 rounded-xl group-hover:scale-110 transition-transform duration-300">
                                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                                            </svg>
                                        </div>
                                        <div class="text-left">
                                            <h4 class="text-lg font-semibold text-gray-900 group-hover:text-primary-600 transition-colors">Update Profile</h4>
                                            <p class="text-sm text-gray-600">Edit your personal information and profile image</p>
                                        </div>
                                    </div>
                                </button>
                                
                                <button onclick="openChangePasswordModal()" class="group p-6 bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl border-2 border-orange-200 hover:border-orange-300 transition-all duration-300 hover:shadow-lg">
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <div class="text-left">
                                            <h4 class="text-lg font-semibold text-gray-900 group-hover:text-orange-600 transition-colors">Change Password</h4>
                    ...
                    <div class="card card-hover fade-in">
                        <div class="card-body p-8">
                            <h3 class="text-2xl font-bold text-gray-900 mb-6">Account Information</h3>
                            <div class="space-y-4">
                                <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-lg font-semibold text-gray-900"><?php echo htmlspecialchars($user_data['first_name'] . ' ' . $user_data['last_name']); ?></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-lg font-semibold text-gray-900"><?php echo htmlspecialchars($user_data['email']); ?></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-lg font-semibold text-gray-900"><?php echo date('F Y', strtotime($user_data['created_at'])); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
