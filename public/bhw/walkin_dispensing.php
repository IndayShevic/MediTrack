...
<body class="bg-gradient-to-br from-gray-50 to-blue-50 bhw-theme">
    ...
    <main class="main-content">
        ...
        <div class="content-header">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Walk-in Medicine Dispensing</h1>
                    <p class="text-gray-600 mt-1">Immediate medicine dispensing for both registered and walk-in residents</p>
                </div>
    ...
    <script>
        ...
        function initProfileDropdown() {
            ...
            if (!window.bhwWalkinProfileDropdownClickHandler) {
                window.bhwWalkinProfileDropdownClickHandler = function(e) {
                    const toggle = document.getElementById('profile-toggle');
                    const menu = document.getElementById('profile-menu');
                ...
                document.addEventListener('click', window.bhwWalkinProfileDropdownClickHandler);
            }
