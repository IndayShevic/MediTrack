...
<head>
    ...
    <title>Allocations · Resident</title>
        ...
        <div class="content-header">
            <div class="flex items-center justify-between">
                <div class="animate-fade-in-up">
                    ...
                    <p class="text-gray-600 text-lg"><?php echo $is_senior ? 'Senior citizen medicine allocations and programs' : 'View your medicine allocations and benefits'; ?></p>
                ...
                <div class="flex items-center space-x-4 animate-slide-in-right">
                    <?php if ($is_senior): ?>
                        <div class="gradient-border">
                            <div class="senior-badge inline-flex items-center px-4 py-2 rounded-full text-sm font-medium">
                                <svg class="w-4 h-4 mr-2 animate-float" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="text-right glass-effect px-4 py-2 rounded-xl">
                        ...
                        <div class="text-sm font-semibold text-gray-900" id="allocation-count"><?php echo count($allocations); ?> allocations</div>
                    </div>
                </div>
            </div>
        </div>
