    ...
    <main class="main-content">
        ...
        <div class="content-header">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">My Allocations</h1>
                    <p class="text-gray-600 mt-1"><?php echo $is_senior ? 'Senior citizen medicine allocations and programs' : 'View your medicine allocations and benefits'; ?></p>
                </div>
