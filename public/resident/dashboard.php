...
<body class="bg-gradient-to-br from-gray-50 to-blue-50 resident-theme">
    ...
    <main class="main-content">
        ...
        <!-- Greeting Section (moved from old header) -->
        <div class="p-4 sm:p-6 lg:p-8">
            <div class="mb-6">
                <h1 class="text-2xl sm:text-3xl font-semibold text-gray-900 mb-1">Welcome back, <?php echo htmlspecialchars($user['name']); ?></h1>
                <p class="text-gray-600"><?php echo $is_senior ? 'Senior citizen' : 'Resident'; ?> dashboard for medicine requests and health care</p>
        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Mobile menu toggle for resident pages
