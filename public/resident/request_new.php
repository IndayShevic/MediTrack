...
<body class="bg-gradient-to-br from-gray-50 to-blue-50 resident-theme">
    ...
    <main class="main-content">
        ...
        <div class="p-4 sm:p-6 lg:p-8">
            <div class="mb-6">
                <h1 class="text-2xl sm:text-3xl font-semibold text-gray-900 mb-1">Request Medicine</h1>
                <p class="text-gray-600">Submit a request for medicine with proof of need.</p>
            </div>
