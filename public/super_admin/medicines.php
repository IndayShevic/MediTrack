        ...
        <div class="content-header">
            <div class="flex items-center justify-between">
                <div class="animate-fade-in-up">
                    ...
                    <p class="text-gray-600 text-lg">Manage your medicine inventory and catalog</p>
                ...
                <div class="flex items-center space-x-4 animate-slide-in-right">
                    <div class="text-right glass-effect px-4 py-2 rounded-xl">
                        <div class="text-xs text-gray-500 uppercase tracking-wide">Total Medicines</div>
                        <div class="text-2xl font-bold text-gray-900" id="medicine-count"><?php echo count($meds); ?></div>
                    </div>
                </div>
            </div>
        </div>
